...
git-lib: https://github.com/mumiao2000/CrossLinear.git
"""
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        # embedding
        self.alpha = nn.Parameter(torch.ones([1]) * configs.correlation_weight)
        self.beta = nn.Parameter(torch.ones([1]) * configs.pos_weight)
